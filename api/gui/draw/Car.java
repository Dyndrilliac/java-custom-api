...
public class Car extends JPanel
{
    ...
    public void stopRadio()
    {
        try
        {
            ...
            {
                // I chose YouTube as my way of implementing the "radio" functionality.
                // The only way I could turn it off is by closing the browser window.
                // Unfortunately, I couldn't figure out a more elegant way to do this than closing all open browser windows.
                // If you have a more user friendly strategy in mind, I'd love to hear about it.
