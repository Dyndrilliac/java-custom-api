 ...
 * Date: 3/22/2014
 *
 * This class provides a graphical display to the user that shows a simulation of an infection spreading
...
public class HealthGrid extends JPanel
{
	...
	{
		final int MAX_Z = ((Double)Math.pow(Math.max((double)this.getNumberOfColumns(), (double)this.getNumberOfRows()),
			3.0)).intValue();
	...
	protected void iterateCell(final Cell[][] grid, final Cell cell, final int num1, final int num2, final int num3,
		final boolean diagonalNeighbors)
	{
