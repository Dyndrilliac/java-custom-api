 ...
 * I wanted a text box object with much richer features, like the RichTextBox control available in Visual Basic or C#.
 * Thus, the RichTextPane class was born.
 */
...
public class RichTextPane extends JTextPane
{
    ...
    {
        /*
         * The append() helper method takes three arguments.
         * In order for variable number of arguments to work, the number of arguments must be evenly divisible by three and they must also be in the correct order: Color, Color, String
         */
        if ( ( arguments.length % 3 ) != 0 ) { throw new IllegalArgumentException("The variable argument append method received a number of arguments not evenly divisible by three."); }
