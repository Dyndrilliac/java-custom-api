 ...
 * Date: 1/21/2012
 * 
 * I wrote this class in a previous Java course because I was not satisfied with JTextPane, and lusted after a text box object with much richer
 * features like the RichTextBox control available in Visual Basic and C#. Thus, RichTextPane was born.
 */
...
public class RichTextPane extends JTextPane
{
    ...
    public static SimpleAttributeSet getAttributeSet(final Color fgc,
        final Color bgc,
        final boolean isBolded,
        final boolean isItalicized,
    ...
    {
        /*
         * The append() helper method takes three arguments. In order for variable number of arguments to work, the number of arguments must be evenly
         * divisible by three and they must also be in the correct order: Color, Color, String
         */
