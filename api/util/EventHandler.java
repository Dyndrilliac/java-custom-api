 ...
 * Date: 3/12/2013
 * 
 * This class allows me to keep my application window class separate from my application logic. Objects (like my application window) call event
 * handlers. By default, the handlers do nothing. Alternatively, custom event handling code can be supplied either when the object is created or
