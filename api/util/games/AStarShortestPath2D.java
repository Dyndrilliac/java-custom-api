 ...
 * Date: 10/25/2013
 * 
 * This class uses the A* search algorithm to find the shortest path from the start point to the goal point within a 2-dimensional plane while avoiding polygonal obstacles.
 */
...
public class AStarShortestPath2D
{
    ...
    {
        if ( ( filePath == null ) || filePath.isEmpty() ) { throw new IllegalArgumentException(); }
        ...
        try
        {
            ...
            // Each coordinate pair is separated by a semicolon. The actual coordinates are separated by commas.
