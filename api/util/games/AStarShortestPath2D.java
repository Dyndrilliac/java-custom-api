 ...
 * Date: 10/25/2013
 * 
 * This class uses the A* search algorithm to find the shortest path from the start point to the goal point within a 2-dimensional plane while
...
public class AStarShortestPath2D
{
    ...
    public final static class MapDisplay extends JPanel
    {
        ...
        public void paint(final Graphics g)
        {
            ...
            v = new Ellipse2D.Double(this.shortestPath.getStartPoint().getX() * this.magnification,
                this.shortestPath.getStartPoint().getY() * this.magnification,
                3,
                3);
            ...
            v = new Ellipse2D.Double(this.shortestPath.getGoalPoint().getX() * this.magnification,
                this.shortestPath.getGoalPoint().getY() * this.magnification,
                3,
                3);
    ...
    private LinkedList<Node>       vertices   = null;                  // List of all vertices/points/nodes of interest (including start and goal).
                                                                        
    public AStarShortestPath2D(final boolean debugMode,
        final Node startPoint,
        final Node goalPoint,
        final LinkedList<Node> vertices,
        final LinkedList<Edge2D> edges)
    {
