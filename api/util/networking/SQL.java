...
public final class SQL
{
			...
			try
			{
				...
				while ((line = lineReader.readLine()) != null)
				{
					...
					*/
					...
					else if (!this.isFullLineDelimiter() && trimmedLine.endsWith(this.getDelimiter())
	...
	public static Connection createConnection(final String server, final String username, final String password)
		throws SQLException
	{
		...
		*/
		...
		connection = DriverManager.getConnection("jdbc:oracle:thin:@" + server, username, password);
