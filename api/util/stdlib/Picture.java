 ...
 * <p>
 * Pixel (<em>x</em>, <em>y</em>) is column <em>x</em> and row <em>y</em>. By default, the origin (0, 0) is upper left, which is a common convention in image
 * processing. The method <tt>setOriginLowerLeft()</tt> change the origin to the lower left.
 * <p>
...
public final class Picture implements ActionListener
{
	...
	{
		FileDialog chooser = new FileDialog(this.frame,
	 ...
	 *             unless both 0 &le; <tt>col</tt> &lt; <tt>width</tt> and 0 &le; <tt>row</tt> &lt; <tt>height</tt>
	 */
