...
/*************************************************************************
 * Compilation: javac Draw.java Execution: java Draw Drawing library. This class provides a basic capability for creating drawings with your programs.
 * It uses a simple graphics model that allows you to create drawings consisting of points, lines, and curves in a window on your computer and to save
 * the drawings to a file. This is the object-oriented version of standard draw; it supports multiple indepedent drawing windows. Todo ---- - Add
 * support for gradient fill, etc. Remarks ------- - don't use AffineTransform for rescaling since it inverts images and strings - careful using
 * setFont in inner loop within an animation - it can cause flicker
 *************************************************************************/
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener
{
    ...
    /**
     * Shade of blue used in Introduction to Programming in Java. The RGB values are (9, 90, 166).
     */
    ...
    public void picture(final double x, final double y, final String s, final double w, final double h)
    {
        ...
        {
            this.offscreen.drawImage(image,
    ...
    public void save(final String filename)
    {
        ...
        else if (suffix.toLowerCase().equals("jpg"))
        {
            ...
            newRaster = raster.createWritableChild(0, 0, this.width, this.height, 0, 0, new int[] {
                0, 1, 2
            });
