...
/*************************************************************************
 * Compilation: javac BinaryStdOut.java Execution: java BinaryStdOut Write binary data to standard output, either one 1-bit boolean, one 8-bit char,
 * one 32-bit int, one 64-bit double, one 32-bit float, or one 64-bit long at a time. The bytes written are not aligned.
 *************************************************************************/
 ...
 * <tt>int</tt>, <tt>long</tt>, <tt>float</tt>, and <tt>double</tt>) to sequences of bits and writing them to standard output. Uses big-endian
