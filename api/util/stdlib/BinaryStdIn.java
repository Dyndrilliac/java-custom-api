 ...
 * (as an <tt>int</tt> or <tt>float</tt>), or 64 bits at a time (as a <tt>double</tt> or <tt>long</tt>).
 * <p>
 ...
 * <p>
 * The client should not intermix calls to <tt>BinaryStdIn</tt> with calls to <tt>StdIn</tt> or <tt>System.in</tt>; otherwise unexpected behavior will result.
 *
