...
/*************************************************************************
 * Compilation: javac BinaryIn.java Execution: java BinaryIn input output This library is for reading binary data from an input stream. % java
 * BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *************************************************************************/
 ...
 * 8 bits at a time (as a <tt>byte</tt> or <tt>char</tt>), 16 bits at a time (as a <tt>short</tt>), 32 bits at a time (as an <tt>int</tt> or
 ...
 * <p>
 * The client should not intermix calls to <tt>BinaryIn</tt> with calls to <tt>In</tt>; otherwise unexpected behavior will result.
 *
...
public final class BinaryIn
{
     ...
     * @throws RuntimeException if the input stream is empty or if the number of bits available is not a multiple of 8 (byte-aligned)
     */
