...
public class KeyValueNode<K, V> extends Node
{
    ...
    public boolean equals(final Object obj)
    {
        ...
        if ( !( obj instanceof KeyValueNode ) ) { return false; }

        KeyValueNode<?, ?> other = (KeyValueNode<?, ?>) obj;

        if ( this.getKeyValuePair() == null )
        {
            if ( other.getKeyValuePair() != null ) { return false; }
        }
        else if ( !this.getKeyValuePair().equals(other.getKeyValuePair()) ) { return false; }
