...
public final class Support
{
    ...
    public final static void displayException(final Component parent, final Exception exception, final boolean isFatal)
    {
        ...
        /*
         * Display error message along with some useful debugging information. Source file is where the error chain ended, which could be null in the
         * case of a function in the Java API. Cause file is where the error chain began, which is the bottom of the stack and where the bad method is
         * likely to be.
         */
        ...
        JOptionPane.showMessageDialog(parent, exception.toString() + "\n\nSource file: " +
            ...
            "\n\nCause file: " +
            exception.getStackTrace()[exception.getStackTrace().length - 1].getFileName() +
            "\nLine number: " +
            exception.getStackTrace()[exception.getStackTrace().length - 1].getLineNumber() +
            "\n\nWhen: " +
            Support.getDateTimeStamp() +
            "\n\nRecovery: " +
            recoveryMessage, dialogTitle, JOptionPane.ERROR_MESSAGE);
        exception.printStackTrace();
    ...
    /*
     * This method is a wrapper for a specific invocation of JOptionPane.showConfirmDialog that I use frequently to prompt test users for debugging
     * modes.
     */
