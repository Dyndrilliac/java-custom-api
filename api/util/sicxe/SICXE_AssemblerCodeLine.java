...
public class SICXE_AssemblerCodeLine
{
	...
	{
		/*
		 * Line format (space delimited):
		 * 
		 * label opCode operand(s) comment
		 * 
		 * label & comment are optional fields.
		 * operand(s) are comma delimited.
		...
		ArrayList<Token<TokenType>> tokens = (new SICXE_Lexer<TokenType>()).lex(s);
		int opCodeToken = -1;
